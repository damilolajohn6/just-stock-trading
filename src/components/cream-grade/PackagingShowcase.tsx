  ...
  return (
    <section className="py-32 bg-muted/30 overflow-hidden relative">
      ...
      <div className="absolute top-0 left-0 w-full h-full opacity-[0.03] pointer-events-none">
        <div className="absolute top-1/4 right-0 w-[500px] h-[500px] rounded-full bg-primary blur-[150px]" />
      </div>
      ...
      <div className="container mx-auto px-4 relative z-10">
        ...
        <div className="max-w-4xl mx-auto text-center mb-20">
          <motion.span
            ...
            viewport={{ once: true }}
            className="text-primary font-bold uppercase tracking-[0.4em] text-[10px] mb-4 block"
          >
          ...
          <motion.p
            ...
            className="text-foreground/50 text-xl font-light max-w-2xl mx-auto"
          >
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
          {packagingOptions.map((item, index) => (
            <motion.div
              ...
              className="group"
            >
              <div className="relative bg-white rounded-[2rem] overflow-hidden shadow-lg hover:shadow-2xl transition-all duration-700 hover:-translate-y-2 border border-primary/5">
                {/* Image */}
                <div className="relative aspect-[4/3] overflow-hidden">
                  ...
                  <motion.div
                    ...
                    className="absolute top-4 right-4 bg-white/90 backdrop-blur-md px-4 py-2 rounded-full border border-primary/10"
                  >
                    <span className="text-primary font-display font-bold text-lg">
                      {item.stat}
                    </span>
                    <span className="text-foreground/40 text-[9px] font-bold uppercase tracking-wider ml-1">
                      {item.statLabel}
                    </span>
                  </motion.div>
                  ...
                  <div className="absolute bottom-4 left-4">
                    <div className="w-10 h-10 rounded-xl bg-white/20 backdrop-blur-md flex items-center justify-center text-white group-hover:bg-primary/90 transition-colors duration-500">
                      <item.icon size={20} />
                    </div>
                  </div>
                </div>
        ...
        >
          ...
          <a
            href="/contact-us"
            className="px-8 py-4 bg-foreground text-white rounded-full font-bold hover:bg-primary hover:text-foreground transition-all duration-300 shadow-xl shadow-primary/10"
          >
            Request a Quote
          </a>
        </motion.div>
