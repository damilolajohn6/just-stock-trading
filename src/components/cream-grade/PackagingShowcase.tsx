...
export default function PackagingShowcase() {
  return (
    <section className="py-32 bg-premium-cream/50 overflow-hidden relative">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
          {packagingOptions.map((item, index) => (
            <motion.div
              ...
              className="group"
            >
              <div className="relative bg-white rounded-[2rem] overflow-hidden shadow-lg hover:shadow-2xl transition-all duration-700 hover:-translate-y-2 border border-premium-gold/10">
                {/* Image */}
